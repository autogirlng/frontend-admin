...
const AddressInput = ({
  ...
  // ✅ Robust script loading and service initialization
  useEffect(() => {
    // Services will be initialized by this callback
    ...
    window.initGooglePlaces = initializeServices;
  ...
  // ✅ Fetch address suggestions (minor change)
  useEffect(() => {

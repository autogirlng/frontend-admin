...
const RequestInfoModal: React.FC<RequestInfoModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Requesting additional info:', { bookingId, requestedInfo: selectedOptions, customerEmail });
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Request Additional Information" size="md">

...
import { useCreateConsolidatedInvoice } from "./useConsolidatedInvoices";
...
export function CreateConsolidatedModal({
  onClose,
}: CreateConsolidatedModalProps) {
  // --- State ---
        ...
        <div className="flex-none flex items-center justify-between p-4 border-b border-gray-100 bg-white z-10">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              Select bookings to group together.
            </p>
          </div>
          <button
            onClick={onClose}

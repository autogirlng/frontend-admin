...
import { useConfirmConsolidatedInvoice, useGetConsolidatedInvoiceById } from "@/components/dashboard/bookings-management/useConsolidatedInvoices"
...
export const ConfirmConsolidatedModal: React.FC<ConfirmConsolidatedModalProps> = ({
    isOpen,
    onClose,
    onSuccess,
    invoice
    ...
    const { data: consolidatedInvoiceData } = useGetConsolidatedInvoiceById(invoice.id);
    ...
    const confirm = async () => {
        ...
        if (globalFile && consolidatedInvoiceData) {
            ...
            const payload = {
                ...invoice,
                invoiceNumbers: consolidatedInvoiceData.invoiceNumbers,

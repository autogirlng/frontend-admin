...
const Button = ({
  ...
  const btnStyles = {
    filled: {
      primary:
        "bg-primary-500 hover:bg-primary-600 text-white disabled:bg-grey-300 disabled:text-grey-500",
      white:
        "bg-white hover:bg-grey-100 text-grey-900 disabled:bg-grey-300 disabled:text-grey-500",
      danger:
        "bg-error-500 hover:bg-error-600 text-white disabled:bg-grey-300 disabled:text-grey-500",
    },
    outlined: {
      primary:
        "border-2 border-primary-500 text-primary-500 hover:bg-primary-50 disabled:border-grey-300 disabled:text-grey-500",
      white:
        "border-2 border-white text-white hover:bg-white/10 disabled:border-grey-300 disabled:text-grey-500",
      danger:
        "border-2 border-error-500 text-error-500 hover:bg-error-50 disabled:border-grey-300 disabled:text-grey-500",
    },
    ghost: {
